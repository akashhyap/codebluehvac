...
---
<Layout title="Code Blue HVAC | 24/7 HVAC Contractor in North Las Vegas, NV" description="Code Blue HVAC – Family-owned HVAC contractor in North Las Vegas. Commercial & residential AC repair, heating, ductwork & mini-splits. BBB A+ accredited. Call (702) 827-1184.">
<Header />
<main>
<Hero />
...
build_page(f"{BASE}/services/ac-cooling.astro",
    ...
    "Complete AC and cooling services in North Las Vegas and the Las Vegas Valley. Expert AC repair, installation, replacement, maintenance and 24/7 emergency service. Call (702) 827-1184.",
    [
...
build_page(f"{BASE}/services/heating.astro",
    ...
    "Expert heating and furnace services in North Las Vegas. Furnace repair, installation, replacement, and maintenance. 24/7 emergency service. Call (702) 827-1184.",
    [
...
build_page(f"{BASE}/services/commercial-hvac.astro",
    ...
    "Full-service commercial HVAC for businesses in North Las Vegas and Clark County. Installation, repair, and maintenance. Call (702) 827-1184.",
    [
...
build_page(f"{BASE}/services/ductwork-air-quality.astro",
    ...
    "Professional ductwork installation, repair, cleaning, and air purification services in North Las Vegas. Improve your indoor air quality. Call (702) 827-1184.",
    [
...
build_page(f"{BASE}/services/ductless-mini-splits.astro",
    ...
    "Expert ductless mini-split installation and repair in North Las Vegas. Energy-efficient zone cooling and heating. Call (702) 827-1184.",
    [
...
spokes = [
    ...
    ("ac-installation", "AC Installation", "AC & Cooling", "/services/ac-cooling", "Professional AC installation in North Las Vegas. New systems sized for your home with top brands. Free estimates. Call (702) 827-1184.", "New System Installation", "Professional AC", "Installation",
    ...
    ("ac-replacement", "AC Replacement", "AC & Cooling", "/services/ac-cooling", "AC replacement services in North Las Vegas. Upgrade to a high-efficiency system. Free estimates, financing available. Call (702) 827-1184.", "System Replacement", "Time for an", "AC Upgrade",
    ...
    ("ac-maintenance", "AC Maintenance", "AC & Cooling", "/services/ac-cooling", "AC maintenance and tune-up services in North Las Vegas. Prevent breakdowns and extend system life. Call (702) 827-1184.", "Preventative Maintenance", "Keep Your AC", "Running Strong",
    ...
    ("emergency-ac-repair", "Emergency AC Repair", "AC & Cooling", "/services/ac-cooling", "24/7 emergency AC repair in North Las Vegas. No extra charge for nights, weekends, or holidays. Call (702) 827-1184 now.", "Emergency Service", "24/7 Emergency", "AC Repair",
    ...
    # Heating Spokes
    ("furnace-repair", "Furnace Repair", "Heating", "/services/heating", "Expert furnace repair in North Las Vegas. Gas and electric furnaces, all brands. 24/7 emergency service. Call (702) 827-1184.", "Furnace Repair Experts", "Fast, Expert", "Furnace Repair",
    ...
    ("furnace-installation", "Furnace Installation", "Heating", "/services/heating", "New furnace installation in North Las Vegas. Energy-efficient systems, professional installation. Free estimates. Call (702) 827-1184.", "New Furnace Installation", "Professional", "Furnace Installation",
    ...
    ("heating-maintenance", "Heating Maintenance", "Heating", "/services/heating", "Heating and furnace maintenance in North Las Vegas. Keep your system safe, efficient, and reliable. Call (702) 827-1184.", "Heating Maintenance", "Keep Your Heating", "System Safe",
    ...
    # Commercial Spokes
    ("commercial-ac-repair", "Commercial AC Repair", "Commercial HVAC", "/services/commercial-hvac", "Fast commercial AC repair in North Las Vegas. Minimize downtime for your business. 24/7 emergency service. Call (702) 827-1184.", "Commercial AC Repair", "Fast Commercial", "AC Repair",
    ...
    ("commercial-installation", "Commercial HVAC Installation", "Commercial HVAC", "/services/commercial-hvac", "Commercial HVAC installation in North Las Vegas. New systems designed for your business. Free estimates. Call (702) 827-1184.", "Commercial Installation", "Commercial HVAC", "Installation",
    ...
    ("commercial-maintenance", "Commercial HVAC Maintenance", "Commercial HVAC", "/services/commercial-hvac", "Commercial HVAC maintenance programs in North Las Vegas. Prevent breakdowns and optimize efficiency. Call (702) 827-1184.", "Commercial Maintenance", "Preventative", "Commercial Maintenance",
    ...
    # Ductwork & IAQ Spokes
    ("ductwork-installation", "Ductwork Installation", "Ductwork & Air Quality", "/services/ductwork-air-quality", "Custom ductwork installation in North Las Vegas. Optimize airflow and HVAC efficiency. Call (702) 827-1184.", "Ductwork Installation", "Professional", "Ductwork Installation",
    ...
    ("ductwork-repair", "Ductwork Repair", "Ductwork & Air Quality", "/services/ductwork-air-quality", "Ductwork repair and sealing in North Las Vegas. Fix leaks, restore efficiency. Call (702) 827-1184.", "Ductwork Repair", "Seal Leaks &", "Restore Efficiency",
    ...
    ("duct-cleaning", "Duct Cleaning", "Ductwork & Air Quality", "/services/ductwork-air-quality", "Professional duct cleaning in North Las Vegas. Remove dust, allergens, and debris. Breathe cleaner air. Call (702) 827-1184.", "Duct Cleaning", "Professional", "Duct Cleaning",
    ...
    ("air-purification", "Air Purification", "Ductwork & Air Quality", "/services/ductwork-air-quality", "Whole-home air purification systems in North Las Vegas. UV lights, HEPA filters, and more. Call (702) 827-1184.", "Air Purification", "Breathe Cleaner", "Indoor Air",
    ...
    # Ductless Spokes
    ("ductless-installation", "Ductless Installation", "Ductless Mini-Splits", "/services/ductless-mini-splits", "Ductless mini-split installation in North Las Vegas. Zone cooling and heating. Free estimates. Call (702) 827-1184.", "Ductless Installation", "Professional", "Ductless Installation",
    ...
    ("ductless-repair", "Ductless Repair", "Ductless Mini-Splits", "/services/ductless-mini-splits", "Ductless mini-split repair in North Las Vegas. Expert diagnosis and repair for all brands. Call (702) 827-1184.", "Ductless Repair", "Expert", "Ductless Repair",
...
build_page(f"{BASE}/service-areas/index.astro",
    ...
    "Code Blue HVAC serves North Las Vegas, Las Vegas, Henderson, Summerlin, Boulder City, Paradise, and surrounding Clark County areas. Call (702) 827-1184.",
    [
...
for slug, name, desc_phrase, detail in areas:
    build_page(f"{BASE}/service-areas/{slug}.astro",
        ...
        f"Code Blue HVAC provides expert AC repair, heating, ductwork, and mini-split services in {name}, NV. 24/7 emergency service. Call (702) 827-1184.",
        [
...
build_page(f"{BASE}/financing.astro",
    ...
    "Flexible HVAC financing options from Code Blue HVAC. Make AC and heating system upgrades affordable. Call (702) 827-1184 for details.",
    [
...
build_page(f"{BASE}/specials.astro",
    ...
    "Current HVAC specials and discounts from Code Blue HVAC. 15% off for seniors, veterans, and first responders. Call (702) 827-1184.",
    [
...
build_page(f"{BASE}/contact.astro",
    ...
    "Contact Code Blue HVAC for HVAC service in North Las Vegas and the Las Vegas Valley. Call (702) 827-1184 or fill out our contact form.",
    [
        hero_section([("Home","/"),("Contact",None)], "Contact Us", "Get in touch for a free estimate or to schedule HVAC service."),
        content_section("Get in Touch","Contact","Code Blue HVAC",["We are here to help with all your heating, cooling, and air quality needs. Whether you need emergency service, want to schedule maintenance, or are interested in a free estimate for a new system, our friendly team is ready to assist.","Phone: (702) 827-1184 — Available 24/7 for emergencies.","Email: info@codebluehvac.com","Address: 3612 Sandy Brown Ave, North Las Vegas, NV 89031","Facebook: facebook.com/Chris.codebluehvac"]),
